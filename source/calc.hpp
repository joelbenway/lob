...
/* const size_t kLutSize = 45;
const std::array<float, kLutSize> kOptimizedMachValues = {
    0.0F,   0.1F,   0.2F,   0.3F,   0.4F,   0.5F,   0.55F,  0.6F,   0.7F,
    0.75F,  0.775F, 0.8F,   0.825F, 0.85F,  0.875F, 0.9F,   0.925F, 0.95F,
    0.975F, 1.0F,   1.025F, 1.05F,  1.075F, 1.1F,   1.125F, 1.15F,  1.2F,
    1.25F,  1.3F,   1.35F,  1.4F,   1.5F,   1.6F,   1.7F,   1.9F,   2.1F,
    2.3F,   2.5F,   2.7F,   2.9F,   3.2F,   3.6F,   4.0F,   4.4F,   5.0F};

const std::array<float, kLutSize> kOptimizedG1DragCoefficents = {
    0.2629F, 0.2487F, 0.2344F, 0.2214F, 0.2104F, 0.2032F, 0.202F,  0.2034F,
    0.2165F, 0.2313F, 0.2417F, 0.2546F, 0.2706F, 0.2901F, 0.3136F, 0.3415F,
    0.3734F, 0.4084F, 0.4448F, 0.4805F, 0.5136F, 0.5427F, 0.5677F, 0.5883F,
    0.6053F, 0.6191F, 0.6393F, 0.6518F, 0.6589F, 0.6621F, 0.6625F, 0.6573F,
    0.6474F, 0.6347F, 0.6072F, 0.5804F, 0.5577F, 0.5397F, 0.5264F, 0.5168F,
    0.5084F, 0.503F,  0.5006F, 0.4995F, 0.4988F};

const std::array<float, kLutSize> kOptimizedG2DragCoefficents = {
    0.2303F, 0.2287F, 0.2251F, 0.2196F, 0.2107F, 0.198F,  0.1905F, 0.1828F,
    0.1702F, 0.1669F, 0.1664F, 0.1667F, 0.1682F, 0.1711F, 0.1761F, 0.1831F,
    0.2004F, 0.2589F, 0.3492F, 0.3983F, 0.4075F, 0.4103F, 0.4114F, 0.4106F,
    0.4089F, 0.4068F, 0.4021F, 0.3966F, 0.3904F, 0.3835F, 0.3759F, 0.3594F,
    0.3432F, 0.3282F, 0.3033F, 0.2846F, 0.2696F, 0.2572F, 0.246F,  0.2357F,
    0.2217F, 0.2052F, 0.1912F, 0.1794F, 0.1648F};

const std::array<float, kLutSize> kOptimizedG5DragCoefficents = {
    0.171F,  0.1727F, 0.1734F, 0.1718F, 0.1668F, 0.1603F, 0.1566F, 0.1529F,
    0.1473F, 0.1463F, 0.1476F, 0.1489F, 0.1536F, 0.1583F, 0.1672F, 0.1815F,
    0.2051F, 0.2413F, 0.2884F, 0.3379F, 0.3785F, 0.4032F, 0.4147F, 0.4201F,
    0.424F,  0.4278F, 0.4338F, 0.4373F, 0.4392F, 0.4403F, 0.4406F, 0.4386F,
    0.4328F, 0.4237F, 0.3991F, 0.3741F, 0.3529F, 0.3349F, 0.3194F, 0.306F,
    0.2889F, 0.2703F, 0.2553F, 0.2429F, 0.228F};

const std::array<float, kLutSize> kOptimizedG6DragCoefficents = {
    0.2617F, 0.2491F, 0.2376F, 0.2278F, 0.2205F, 0.2155F, 0.2138F, 0.2126F,
    0.2122F, 0.2132F, 0.2143F, 0.2154F, 0.2174F, 0.2194F, 0.2229F, 0.2297F,
    0.2449F, 0.2732F, 0.3141F, 0.3597F, 0.3994F, 0.4261F, 0.4402F, 0.4465F,
    0.449F,  0.4497F, 0.4482F, 0.4441F, 0.439F,  0.4336F, 0.4279F, 0.4162F,
    0.4042F, 0.3919F, 0.3652F, 0.3381F, 0.3122F, 0.2883F, 0.2668F, 0.2487F,
    0.2265F, 0.2039F, 0.1866F, 0.173F,  0.1574F};

const std::array kOptimizedG7DragCoefficents = {
    0.1198F, 0.1196F, 0.1193F, 0.1194F, 0.1193F, 0.1194F, 0.1193F, 0.1194F,
    0.1202F, 0.1215F, 0.1226F, 0.1242F, 0.1266F, 0.1306F, 0.1368F, 0.1464F,
    0.166F,  0.2054F, 0.2993F, 0.3803F, 0.4015F, 0.4043F, 0.4034F, 0.4014F,
    0.3987F, 0.3955F, 0.3884F, 0.381F,  0.3732F, 0.3657F, 0.358F,  0.344F,
    0.3315F, 0.3209F, 0.3042F, 0.2922F, 0.2807F, 0.2697F, 0.2588F, 0.2479F,
    0.2313F, 0.2106F, 0.1935F, 0.1793F, 0.1618F};

const std::array<float, kLutSize> kOptimizedG8DragCoefficents = {
    0.2105F, 0.2104F, 0.2103F, 0.2103F, 0.2103F, 0.2102F, 0.2102F, 0.2102F,
    0.2103F, 0.2103F, 0.2103F, 0.2104F, 0.2104F, 0.2105F, 0.2106F, 0.2109F,
    0.2183F, 0.2571F, 0.3358F, 0.4068F, 0.4378F, 0.4476F, 0.4493F, 0.4477F,
    0.445F,  0.4419F, 0.4353F, 0.4283F, 0.4208F, 0.4133F, 0.4059F, 0.3915F,
    0.3777F, 0.3645F, 0.34F,   0.3182F, 0.2983F, 0.2802F, 0.2642F, 0.2499F,
    0.2308F, 0.2101F, 0.195F,  0.1837F, 0.1713F};*/
