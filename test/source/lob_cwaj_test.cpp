...
TEST_F(LobCWAJTestFixture, BoatrightRightHandSpinLeftwardWind) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {600, 2759, 4221, 5.89, -2.71, 0.206},
      {900, 2609, 3775, 3.21, -6.50, 0.318},
      {1200, 2464, 3366, -4.58, -11.92, 0.436},
      {1500, 2323, 2992, -18.10, -18.95, 0.562},
      {1800, 2187, 2652, -38.07, -27.89, 0.695},
      {2100, 2056, 2344, -65.32, -38.87, 0.836},
      {2400, 1929, 2064, -100.82, -52.10, 0.987},
      {2700, 1806, 1810, -145.65, -67.79, 1.148},
      {3000, 1687, 1579, -201.15, -86.20, 1.319},
      {4500, 1150, 734, -705.94, -231.13, 2.397},
      {6000, 949, 500, -1860.74, -466.01, 3.867}};
...
TEST_F(LobCWAJTestFixture, BoatrightLeftHandSpinLeftwardWind) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {600, 2759, 4221, 1.63, -2.87, 0.206},
      {900, 2609, 3775, -3.18, -6.63, 0.318},
      {1200, 2464, 3366, -13.09, -12.29, 0.436},
      {1500, 2323, 2992, -28.74, -19.94, 0.562},
      {1800, 2187, 2652, -50.84, -29.76, 0.695},
      {2100, 2056, 2344, -80.21, -41.94, 0.836},
      {2400, 1929, 2064, -117.84, -56.71, 0.987},
      {2700, 1806, 1810, -164.80, -74.34, 1.148},
      {3000, 1687, 1579, -222.42, -95.14, 1.319},
      {4500, 1150, 734, -737.85, -261.60, 2.397},
      {6000, 949, 500, -1903.39, -545.46, 3.868}};
...
TEST_F(LobCWAJTestFixture, BoatrightRightHandSpinRightwardWind) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {3000, 1687, 1579, -222.42, 95.14, 1.319},
      {4500, 1150, 734, -737.85, 261.60, 2.397},
      {6000, 949, 500, -1903.39, 545.68, 3.868}};
...
TEST_F(LobCWAJTestFixture, BoatrightLeftHandSpinRightwardWind) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {1200, 2464, 3366, -4.58, 11.92, 0.436},
      {1500, 2323, 2992, -18.10, 18.95, 0.562},
      {1800, 2187, 2652, -38.07, 27.88, 0.695},
      {2100, 2056, 2344, -65.32, 38.87, 0.836},
      {2400, 1929, 2064, -100.82, 52.10, 0.987},
      {2700, 1806, 1810, -145.65, 67.79, 1.148},
      {3000, 1687, 1579, -201.15, 86.20, 1.319},
      {4500, 1150, 734, -705.94, 231.13, 2.397},
      {6000, 949, 500, -1860.74, 466.23, 3.867}};
