...
struct LobCWAJTestFixture : public testing::Test {
  ...
  void SetUp() override {
    ...
    const double kTestZeroAngle = 6.525;
...
TEST_F(LobCWAJTestFixture, SolveWithoutSpin) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {300, 2913, 4706, 2.92, 0.00, 0.100},
      {600, 2759, 4221, 3.75, 0.00, 0.206},
      {900, 2609, 3775, 0.00, 0.00, 0.318},
      {1200, 2464, 3366, -8.86, 0.00, 0.436},
      {1500, 2323, 2992, -23.45, 0.00, 0.562},
      {1800, 2187, 2652, -44.48, 0.00, 0.695},
      {2100, 2056, 2344, -72.80, 0.00, 0.836},
      {2400, 1929, 2064, -109.37, 0.00, 0.987},
      {2700, 1806, 1810, -155.27, 0.00, 1.148},
      {3000, 1687, 1579, -211.83, 0.00, 1.319},
      {4500, 1150, 734, -721.91, 0.00, 2.397},
      {6000, 949, 499, -1882.11, 0.00, 3.868}};
...
TEST_F(LobCWAJTestFixture, LitzRightHandSpinLeftwardWind) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {600, 2759, 4221, 5.11, -2.60, 0.206},
      {900, 2609, 3775, 2.04, -6.05, 0.318},
      {1200, 2464, 3366, -6.13, -11.09, 0.436},
      {1500, 2323, 2992, -20.04, -17.86, 0.562},
      {1800, 2187, 2652, -40.40, -26.52, 0.695},
      {2100, 2056, 2344, -68.04, -37.20, 0.836},
      {2400, 1929, 2064, -103.92, -50.11, 0.987},
      {2700, 1806, 1810, -149.14, -65.44, 1.148},
      {3000, 1687, 1579, -205.02, -83.43, 1.319},
      {4500, 1150, 734, -711.75, -225.13, 2.397},
      {6000, 949, 499, -1868.59, -455.05, 3.868}};
...
TEST_F(LobCWAJTestFixture, LitzLeftHandSpinLeftwardWind) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {300, 2913, 4706, 2.24, -0.75, 0.100},
      {600, 2759, 4221, 2.39, -3.07, 0.206},
      {900, 2609, 3775, -2.04, -7.09, 0.318},
      {1200, 2464, 3366, -11.58, -12.94, 0.436},
      {1500, 2323, 2992, -26.85, -20.80, 0.562},
      {1800, 2187, 2652, -48.57, -30.85, 0.695},
      {2100, 2056, 2344, -77.57, -43.30, 0.836},
      {2400, 1929, 2064, -114.82, -58.36, 0.987},
      {2700, 1806, 1810, -161.40, -76.31, 1.148},
      {3000, 1687, 1579, -218.64, -97.46, 1.319},
      {4500, 1150, 734, -732.18, -266.99, 2.397},
      {6000, 949, 499, -1895.83, -555.50, 3.868}};
...
TEST_F(LobCWAJTestFixture, BoatrightRightHandSpinLeftwardWind) {
  ...
  constexpr lob::InchT kInchError(0.5);
  constexpr lob::SecT kTimeOfFlightError(0.01);
  constexpr double kAerodynamicJump = 1.052816;
  constexpr size_t kSolutionLength = 14;
  const auto kContext = puut->TwistInchesPerTurn(kBarrelTwist)
                            .WindSpeedMph(kWind)
                            .WindHeading(kWindHeading)
  ...
  const std::vector<lob::Output> kExpected = {
      {0, 3071, 5230, -2.00, 0.00, 0.000},
      {150, 2992, 4963, 1.50, -0.17, 0.049},
      {300, 2913, 4706, 4.03, -0.69, 0.100},
      {600, 2759, 4221, 5.95, -2.83, 0.206},
      {900, 2609, 3775, 3.31, -6.56, 0.318},
      {1200, 2464, 3366, -4.45, -11.91, 0.436},
      {1500, 2323, 2992, -17.93, -18.92, 0.562},
      {1800, 2187, 2652, -37.87, -27.83, 0.695},
      {2100, 2056, 2344, -65.09, -38.80, 0.836},
      {2400, 1929, 2064, -100.55, -52.00, 0.987},
      {2700, 1806, 1810, -145.35, -67.65, 1.148},
      {3000, 1687, 1579, -200.81, -86.01, 1.319},
      {4500, 1150, 734, -705.43, -230.55, 2.397},
      {6000, 949, 499, -1860.16, -464.78, 3.868}};
...
TEST_F(LobCWAJTestFixture, BoatrightLeftHandSpinLeftwardWind) {
  ...
  const std::vector<lob::Output> kExpected = {
      {0, 3071, 5230, -2.00, 0.00, 0.000},
      {150, 2992, 4963, 0.40, -0.17, 0.049},
      {300, 2913, 4706, 1.82, -0.69, 0.100},
      {600, 2759, 4221, 1.54, -2.83, 0.206},
      {900, 2609, 3775, -3.31, -6.63, 0.318},
      {1200, 2464, 3366, -13.27, -12.29, 0.436},
      {1500, 2323, 2992, -28.96, -19.95, 0.562},
      {1800, 2187, 2652, -51.10, -29.78, 0.695},
      {2100, 2056, 2344, -80.52, -41.98, 0.836},
      {2400, 1929, 2064, -118.19, -56.78, 0.987},
      {2700, 1806, 1810, -165.20, -74.44, 1.148},
      {3000, 1687, 1579, -222.86, -95.28, 1.319},
      {4500, 1150, 734, -738.50, -262.12, 2.397},
      {6000, 949, 499, -1904.26, -547.11, 3.868}};
