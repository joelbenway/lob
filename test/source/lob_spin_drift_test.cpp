...
TEST_F(LobSpinTestFixture, LitzRightHandSpinDrift) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {300, 2913, 4706, 2.92, 0.06, 0.100},
      {600, 2759, 4221, 3.75, 0.23, 0.206},
      {900, 2609, 3775, 0.00, 0.52, 0.318},
      {1200, 2464, 3366, -8.86, 0.93, 0.436},
      {1500, 2323, 2992, -23.45, 1.47, 0.562},
      {1800, 2187, 2652, -44.48, 2.17, 0.695},
      {2100, 2056, 2344, -72.80, 3.05, 0.836},
      {2400, 1929, 2064, -109.37, 4.12, 0.987},
      {2700, 1806, 1810, -155.27, 5.44, 1.148},
      {3000, 1687, 1579, -211.83, 7.02, 1.319},
      {4500, 1150, 734, -721.91, 20.93, 2.397},
      {6000, 949, 499, -1882.11, 50.22, 3.868}};
...
TEST_F(LobSpinTestFixture, LitzRightHandSpinDriftFast) {
  ...
  const std::vector<lob::Output> kExpected = {
      {0, 3071, 5230, -2.00, 0.00, 0.000},
      {150, 2992, 4963, 0.95, 0.02, 0.049},
      {300, 2913, 4706, 2.92, 0.08, 0.100},
      {600, 2759, 4221, 3.75, 0.29, 0.206},
      {900, 2609, 3775, 0.00, 0.64, 0.318},
      {1200, 2464, 3366, -8.86, 1.15, 0.436},
      {1500, 2323, 2992, -23.45, 1.83, 0.562},
      {1800, 2187, 2652, -44.48, 2.70, 0.695},
      {2100, 2056, 2344, -72.80, 3.79, 0.836},
      {2400, 1929, 2064, -109.37, 5.13, 0.987},
      {2700, 1806, 1810, -155.27, 6.76, 1.148},
      {3000, 1687, 1579, -211.83, 8.72, 1.319},
      {4500, 1150, 734, -721.91, 26.01, 2.397},
      {6000, 949, 499, -1882.11, 62.42, 3.868}};
...
TEST_F(LobSpinTestFixture, BoatrightRightHandSpinDrift) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {600, 2759, 4221, 3.75, 0.00, 0.206},
      {900, 2609, 3775, 0.00, 0.00, 0.318},
      {1200, 2464, 3366, -8.86, 0.19, 0.436},
      {1500, 2323, 2992, -23.45, 0.51, 0.562},
      {1800, 2187, 2652, -44.48, 0.97, 0.695},
      {2100, 2056, 2344, -72.80, 1.59, 0.836},
      {2400, 1929, 2064, -109.37, 2.39, 0.987},
      {2700, 1806, 1810, -155.27, 3.39, 1.148},
      {3000, 1687, 1579, -211.83, 4.63, 1.319},
      {4500, 1150, 734, -721.91, 15.78, 2.397},
      {6000, 949, 499, -1882.11, 41.16, 3.868}};
...
TEST_F(LobSpinTestFixture, BoatrightRightHandSpinDriftFast) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {600, 2759, 4221, 3.75, 0.00, 0.206},
      {900, 2609, 3775, 0.00, 0.00, 0.318},
      {1200, 2464, 3366, -8.86, 0.24, 0.436},
      {1500, 2323, 2992, -23.45, 0.63, 0.562},
      {1800, 2187, 2652, -44.48, 1.19, 0.695},
      {2100, 2056, 2344, -72.80, 1.95, 0.836},
      {2400, 1929, 2064, -109.37, 2.93, 0.987},
      {2700, 1806, 1810, -155.27, 4.17, 1.148},
      {3000, 1687, 1579, -211.83, 5.68, 1.319},
      {4500, 1150, 734, -721.91, 19.37, 2.397},
      {6000, 949, 499, -1882.11, 50.54, 3.868}};
