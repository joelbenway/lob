...
TEST_F(LobSpinTestFixture, BoatrightRightHandSpinDrift) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {600, 2759, 4221, 3.76, 0.00, 0.206},
      {900, 2609, 3775, 0.02, 0.00, 0.318},
      {1200, 2464, 3366, -8.84, 0.19, 0.436},
      {1500, 2323, 2992, -23.42, 0.49, 0.562},
      {1800, 2187, 2652, -44.45, 0.94, 0.695},
      {2100, 2056, 2344, -72.77, 1.54, 0.836},
      {2400, 1929, 2064, -109.33, 2.31, 0.987},
      {2700, 1806, 1810, -155.23, 3.27, 1.148},
      {3000, 1687, 1579, -211.78, 4.47, 1.319},
      {4500, 1150, 734, -721.84, 15.23, 2.397},
...
TEST_F(LobSpinTestFixture, BoatrightRightHandSpinDriftFast) {
  ...
  const std::vector<lob::Output> kExpected = {
      ...
      {600, 2759, 4221, 3.76, 0.00, 0.206},
      {900, 2609, 3775, 0.02, 0.00, 0.318},
      {1200, 2464, 3366, -8.84, 0.23, 0.436},
      {1500, 2323, 2992, -23.42, 0.607, 0.562},
      {1800, 2187, 2652, -44.45, 1.15, 0.695},
      {2100, 2056, 2344, -72.77, 1.89, 0.836},
      {2400, 1929, 2064, -109.33, 2.83, 0.987},
      {2700, 1806, 1810, -155.23, 4.02, 1.148},
      {3000, 1687, 1579, -211.78, 5.49, 1.319},
      {4500, 1150, 734, -721.84, 18.70, 2.397},
